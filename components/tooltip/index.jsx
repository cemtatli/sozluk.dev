  ...
  return (
    <div className="tooltip group relative flex w-full flex-col items-start justify-center gap-2.5 bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100 px-4 py-2 text-sm text-ebony-900 sm:items-center md:flex-row md:gap-5">
      ...
      <XMarkIcon
        ...
        aria-hidden="true"
        className="hover:ring-offset-0.5 absolute right-2.5 bottom-2 h-4.5 w-4.5 shrink-0 cursor-pointer rounded-full  text-gray-700  transition duration-100 hover:text-gray-900 hover:ring-1 hover:ring-gray-900 hover:ring-offset-gray-900 sm:bottom-3.5"
      />
    </div>
  );
}
